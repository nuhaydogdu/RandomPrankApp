class Ekran {
    ...
    async sakaGetir() {                                                          //buradaki yapımızda kodlar işletilirken sırayla bitmesi bekleniyor
        ...
        const tumSonuclar = {
            rastgeleResim,                                                       //---> rastgeleResim:rastgeleResim,  key değerleri value ile birebir aynıysa yazmak zorunda değiliz 
            rastgeleSaka,
            ceviri
        }
